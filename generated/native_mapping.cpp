...
EXPORTED short snb_link_proc(const char* funcName, int32_t addr) {
	...
	if(
		name == "common.gpio#__srt_global.setup" && addr == 3034
		|| name == "common.gpio#__srt_global.pin_mode" && addr == 3035
		|| name == "common.gpio#__srt_global.write_pin" && addr == 3036
		|| name == "common.gpio#__srt_global.read_pin" && addr == 3037
		|| name == "common.network.driver#__srt_global.setup" && addr == 3060
		|| name == "common.network.driver#__srt_global.set_transmission_lvl" && addr == 3061
		|| name == "common.network.driver#__srt_global.set_transmission_rate" && addr == 3062
		|| name == "common.network.driver#__srt_global.dump_details" && addr == 3063
		|| name == "common.network.driver#__srt_global.set_retry_count" && addr == 3064
		|| name == "common.network.driver#__srt_global.power_down" && addr == 3065
		|| name == "common.network.driver#__srt_global.get_signal_strength" && addr == 3066
		|| name == "common.network.driver#__srt_global.read" && addr == 3067
		|| name == "common.network.driver#__srt_global.send" && addr == 3068
		|| name == "common.network.driver#__srt_global.get_last_error" && addr == 3069
		|| name == "device#__srt_global.get_dst_cm" && addr == 3095
	) {
		return 1;
	}
